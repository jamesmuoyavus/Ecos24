...
class BitmapLoaderTask extends AsyncTask<String,Integer,Bitmap>
{
    ...
    protected Bitmap doInBackground(String... params)
    {
        ...
        try
        {
            ...
            {
                Bitmap musicArt;
                musicArt = HelperMusicClass.decodeBitmapFrombyteArray(mediaArtbyteArray,50,50);
                Log.i("Check","Setting Cache with key "+params[1]);
                HelperMusicClass.setBitmapToCache(params[1],musicArt);
                return musicArt;
            }
        }
    ...
    protected void onPostExecute(Bitmap bm)
    {
        ...
        if(!isCancelled())
        {
            ...
            if (imageViewReference != null && bm != null)
            {
                BitmapLoaderTask bitmapLoaderTask = HelperMusicClass.getBitmapLoaderTask(imageView);
